  ...
  return (
    <>
        <section className='bg-white w-10/12 h-screen dark:bg-black absolute right-0 p-56'>
            <div className='pr-44 pb-4'><h1 className='text-secondary text-7xl font-medium border-b-2 border-gray-200 py-4 pb-9 dark:text-primary'>Contact Us</h1></div>
                    ...
                    <form>
                        <div className="flex flex-row text-secondary">
                            <div className="relative w-6/12 m-2">
                                <input type="text" name="first_name" id="first_name" className="block py-3 px-2 w-full text-sm text-secondary bg-transparent border-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-secondary peer dark:text-primary  dark:border-primary" placeholder="First name" required />
                            ...
                            <div className="relative w-6/12 m-2">
                                <input type="text" name="last_name" id="last_name" className="block py-3 px-2 w-full text-sm text-secondary bg-transparent border-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-secondary peer dark:text-primary dark:border-primary" placeholder="Last name " required />
                        ...
                        <div className="relative m-2">
                            <input type="email" name="email" id="email" className="block py-3 px-4 w-full text-sm text-secondary bg-transparent border-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-secondary peer dark:text-primary dark:border-primary" placeholder="Email address " required />
                        ...
                        <div>
                            <div className="relative m-2">
                                <input type="text" name="message" id="message" className="block py-6 px-4 w-full h-20 text-sm text-secondary bg-transparent border-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-secondary peer p-2 dark:text-primary dark:border-primary" placeholder="Message " required />
                        ...
                        <div className='flex justify-end pr-2 pt-4'>
                            <button className='bg-transparent border-2 border-gray-300 px-6 py-3 dark:text-primary dark:border-primary'>Submit</button>
                        </div>
                    </form>
                </div>
            </div>
